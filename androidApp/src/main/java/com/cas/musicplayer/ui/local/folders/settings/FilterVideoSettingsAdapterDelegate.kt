...
import com.cas.musicplayer.databinding.ItemSettingsFilterVideosBinding
import com.cas.musicplayer.delegateadapter.AdapterDelegate
import com.mousiki.shared.domain.models.DisplayableItem

class FilterVideoSettingsAdapterDelegate : AdapterDelegate<List<DisplayableItem>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        ...
        val binding = ItemSettingsFilterVideosBinding.inflate(from, parent, false)
    ...
    inner class ViewHolder(val binding: ItemSettingsFilterVideosBinding) :
