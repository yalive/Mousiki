...
import com.cas.musicplayer.databinding.LocalVideosSettingsFragmentBinding
...
class LocalVideosSettingsFragment : BaseFragment<LocalVideosSettingsViewModel>(
    R.layout.local_videos_settings_fragment
) {
    ...
    companion object {
        ...
        fun present(activity: FragmentActivity, onChangeSettings: (() -> Unit)) {
            val fragment = activity.slideUpFragment<LocalVideosSettingsFragment>()
