...
public final class FileUtil {
    ...
    public static List<Song> matchFilesWithMediaStore(
        ...
        return new LocalSongsRepository(context).songs(makeSongCursor(context, files));
    }
    ...
    public static SortedCursor makeSongCursor(
        ...
        Cursor songCursor =
                new LocalSongsRepository(context).makeSongCursor(selection, selection == null ? null : paths);
