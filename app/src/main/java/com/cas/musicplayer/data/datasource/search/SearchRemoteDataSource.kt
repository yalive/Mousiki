...
class SearchRemoteDataSource @Inject constructor(
    ...
    private suspend fun searchWithApi(apiUrl: String, query: String): List<MusicTrack> {
        return (mousikiSearchApi.search(apiUrl, query).results
